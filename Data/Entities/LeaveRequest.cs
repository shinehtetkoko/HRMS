...
namespace HRMS.Data.Entities {
    ...
    public class LeaveRequest : IAuditable
    {
        ...
        [Required] public int Leave_Type_Id { get; set; }
        ...
        [Required] public int total_days { get; set; }

        [Required, StringLength(255)] public string reason { get; set; }

        [StringLength(255)] public string? attachment { get; set; }
        ...
        [Required] public DateTime created_at { get; set; } = DateTime.UtcNow;
