...
namespace HRMS.Interfaces
{
    ...
    {
        Task<(bool Success, string Message, bool IsFirstLogin, string Email, string RoleName, string User_Name, int UserId)> ValidateLoginAsync(string email, string password);
