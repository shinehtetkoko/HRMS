...
namespace HRMS.Services
{
    public class EmailService : IEmailService
    {
        ...
        #region Automated Notification Emails
        /// <summary>
        /// Sends a temporary One-Time Password (OTP) via Gmail SMTP to a newly registered user.
        /// </summary>
        /// <param name="toEmail">The recipient's email address.</param>
        /// <param name="userName">The name of the newly registered user.</param>
        /// <param name="tempPassword">The auto-generated temporary password.</param>
        public async Task SendOneTimePasswordAsync(string toEmail, string userName, string tempPassword)
        {
            try
            {
                ...
                var mailMessage = new MailMessage
                {
                    ...
                    Body = $@"
                        <div style='font-family: Inter, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px;'>
                            ...
                            <p style='font-size: 13px; color: #ef4444; font-weight: bold;'>Security Notice:</p>
        ...
        /// <summary>
        /// Sends a secure account recovery password reset link via Gmail SMTP to the user.
        /// </summary>
        /// <param name="email">The recipient's email address.</param>
        /// <param name="resetLink">The dynamic secure password recovery URL link.</param>
